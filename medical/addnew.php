...
$stockArray = $con->query("select * from inventeries");
            ...
            if($row['name']==$n)
            {
                ...
                $q=$row['stock']+$_POST['unit'];

                

                $sql="update inventeries set stock=".$q." where name="."'$n'";
...
if ($con->query("insert into inventeries (catId,supplier,name,unit,price,description,company,stock) values ('$_POST[catId]','$_POST[supplier]','$_POST[name]','$_POST[unit]','$_POST[price]','$_POST[discription]','$_POST[Name]',$_POST[unit])")) {
  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="unit" placeholder="" class="form-control" id="some" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Select Company</label>
