...
<ol class="breadcrumb ">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <h4>Notifications</h4><hr>
          ...
          <?php echo "Only <i style='color:red;'>" .$row['unit']. " " .$row['name']. "</i> is in Stock Please kindelly contact " .$row['supplier']. " Supplier  Of " .$row['company']; ?>
       
          </label>
          </td>
          <td>

          <button class="btn btn-primary btn-xs" onclick="document.location.href='addnew.php'">Add More</button>
