      ...
      <div class="modal-body">
       <form method="POST" action="billout.php">
        <div style="width: 77%;margin: auto;">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Email Id</label>
            <input type="text" name="email" class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Address</label>
            <input type="text" name="add" class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Days</label>
            <input type="text" name="day" class="form-control" id="some" required>
          </div>
           <div class="form-group">
